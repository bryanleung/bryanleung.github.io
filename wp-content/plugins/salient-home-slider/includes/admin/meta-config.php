		...
		switch( $field['type'] ){	
			...
			case 'color':
				...
				wp_enqueue_script(
					...
					SALIENT_HOME_SLIDER_PLUGIN_PATH.'/includes/assets/js/colorpicker.js',
			...
			wp_register_style(
				'nectar-meta-jquery-ui-custom-css',
				 SALIENT_HOME_SLIDER_PLUGIN_PATH.'/includes/assets/css/jquery-ui-1.10.0.custom.css',
				'',
				time(),
				'all'
			);
			...
			wp_enqueue_script(
				...
				SALIENT_HOME_SLIDER_PLUGIN_PATH.'/includes/assets/js/buttonset.js', 
